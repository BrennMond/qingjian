...
//! 架构位置：与 `qingjian_memory::MemoryRanker` 同一个位置（装配时注入的
...
use qingjian_core::{clamp_bonus, is_exact, Candidate, Lane, QueryView, Ranker, Score};
...
mod tests {
    use super::*;
    use qingjian_core::{Candidate, CandidateKind, Context, Origin, QueryView, Span, SpellingAttr};
