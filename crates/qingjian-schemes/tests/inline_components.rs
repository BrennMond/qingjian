...
use qingjian_core::{Engine, FrozenClock, Key, LoadedSchema, Services, Session};
...
fn engine() -> qingjian_engine::EngineImpl {
    ...
    qingjian_engine::EngineImpl::with_services(&defs, Services::new(clock)).expect("编译内联方案")
}
