...
//! `.qingjian-cache` 重新编译才恢复。**全程没有任何诊断。**
//!
...
impl Work {
    ...
    fn type_keys(&self, keys: &str) -> Vec<String> {
        let loaded = qingjian_schemes::load_dir_deployed_layered(&self.root, &self.cache_dir())
