...
//! 架构位置：stele-core 的错误定义，被 Engine 构造、方案加载、配置校验使用。
//!
...
pub struct Diagnostic {
    /// 出问题的来源层（如 `schemes/stele-default/rime_ice.schema.yaml`）。
    pub source: String,
...
impl From<SchemaError> for SteleError {
...
/// 本 crate 的 `Result` 别名。
pub type Result<T> = core::result::Result<T, SteleError>;
