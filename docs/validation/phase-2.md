...
```text
$ ./target/release/stele-bench --scheme-dir schemes/stele-default --iterations=40000
输入                                   P50         P95         P99         max
  nihao                         113.48µs    151.12µs    166.65µs    222.91µs
  nihaoshijie                   643.50µs    981.77µs      1.01ms      5.06ms
  nh                            244.94µs    278.88µs    296.89µs    2.18ms
  nhao                          459.25µs    749.42µs    763.66µs    3.68ms
  ssss                          501.82µs    645.67µs    667.16µs    3.23ms
  woaizhongguo                  591.55µs      1.94ms      2.06ms    2.42ms
